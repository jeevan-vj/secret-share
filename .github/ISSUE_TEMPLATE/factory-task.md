---
name: Factory task
about: Delegate a spec-driven implementation to Cursor Cloud (Codex also supported)
title: "factory: "
labels: "factory:ready"
assignees: ""
---

@cursor Please take ownership of this issue as a software-engineering task for this repository.
...
9. Subscribe to CI/review on that PR and address failures you caused.

Role prompts: `.factory/agents/implementer.md` (and `.factory/automations/implement.md` for Automations).
